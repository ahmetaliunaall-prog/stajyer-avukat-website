...
window.platformReady = new Promise((resolve) => { window.resolvePlatformReady = resolve; });
...
async function connect() {
  ...
  window.resolvePlatformReady(supabase);
}
